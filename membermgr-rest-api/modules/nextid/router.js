...
const nextIdCtl = require('./controller');
 ...
 * }]
 */
// nextIdRouter.get("/", nextIdCtl.getAll);
 ...
 * }
 */
nextIdRouter.get("/", nextIdCtl.get);
 ...
 * }
 */
nextIdRouter.post("/", nextIdCtl.create);
 ...
 * }
 */
nextIdRouter.put("/:id", nextIdCtl.update);
 ...
 * }
 */
// nextIdRouter.delete("/:id", nextIdCtl.delete);

exports = module.exports = nextIdRouter;
