...
const blockCtl = require('./controller');
 ...
 * }]
 */
block_router.get("/", blockCtl.getAll);
 ...
 * }
 */
// block_router.get("/:block_name", blockCtl.get);
 ...
 * }
 */
block_router.post("/", blockCtl.create);
 ...
 * }
 */
// block_router.put("/:id", blockCtl.update);
 ...
 * }
 */
// block_router.delete("/:id", blockCtl.delete);

exports = module.exports = block_router;
