...
RoomCheckinSchema.index({ _block: 1, room_no: 1}, { unique: true });
 

const RoomCheckin = mongoose.model('roomcheckin', RoomCheckinSchema);

exports = module.exports = RoomCheckin;