...
const roomcheckinCtrl = require('./controller');

const room_checkin_router = express.Router();
/**
 ...
 * }]
 */
room_checkin_router.get("/", roomcheckinCtrl.getAll);
...
room_checkin_router.post("/:block_name", roomcheckinCtrl.create);
 ...
 * }
 */
room_checkin_router.put("/:id", roomcheckinCtrl.update);
...
exports = module.exports = room_checkin_router;
